    ...
    <article class="uk-section uk-section-large uk-padding-medium-top">
        <header class="uk-tile-primary uk-panel uk-tile uk-margin-medium uk-border-rounded uk-tile-small">
            ...
            <p class="uk-text-secondary">
                ...
                <a href="mailto:bonge@bonge-inc.co.ke" class="uk-text-warning">bonge@bonge-inc.co.ke</a> with a link or
                an attachment of your
                job listing and we'll fill the drudging form for you.
            </p>

            <a class="uk-button uk-button-link" href="#listing-form" uk-scroll>
                Let's Begin
            </a>
        </header>
            ...
            <fieldset class="uk-fieldset uk-tile uk-tile-default uk-border-rounded">
                ...
                <div class="uk-grid uk-grid-medium uk-child-width-1-1" uk-grid>
                    ...
                    <div class="uk-panel uk-width-1-2@m  ">
                        <label for="title" class="uk-form-label uk-text-bold">Job Title</label>
                    ...
                    <div class="uk-panel uk-width-1-2@m">
                        <label for="category" class="uk-form-label uk-text-bold">Job Category</label>
                        <div class="uk-form-controls">
                    ...
                    <div class="uk-panel uk-width-1-2@m uk-grid-margin">
                        <label for="listing_type" class="uk-form-label uk-text-bold">Job Type</label>
                        <div class="uk-form-controls">
                            <select wire:model.defer="listing_type" id="listing_type"
                    ...
                    <div class="uk-width-1-2@m uk-grid-margin">
                        <div class="uk-grid match uk-grid-medium" uk-grid>
                            <div class="uk-panel uk-width-expand@m">
                                <label for="employee_availability" class="uk-form-label uk-text-bold">
                                    Employee Availability
                                </label>
                                <div class="uk-form-controls">
                                    <select wire:model.lazy="employee_availability" id="employee_availability"
                            ...
                            <div class="uk-panel uk-width-auto@m">
                                <label for="on_site_days" class="uk-form-label uk-text-bold">
                                    On site days (1-5)
                                </label>
                                <div class="uk-form-controls uk-text-middle">
                                    <input type="number" wire:model.defer="on_site_days" id="on_site_days" min="1"
                                        max="5"
                    ...
                    <div class="uk-panel uk-width-1-2@m uk-grid-margin">
                        <label for="apply_url" class="uk-form-label uk-text-bold">Apply link</label>
                        <div class="uk-form-controls">
                            <input type="url" wire:model.defer="apply_url" id="apply_url"
                    ...
                    <div class="uk-panel uk-width-1-2@m uk-grid-margin">
                        <label for="location" class="uk-form-label uk-text-bold">Location</label>
                        <div class="uk-form-controls">
                    ...
                    <div class="uk-panel uk-grid-margin">
                        <label for="overview" class="uk-form-label uk-text-bold">About the job</label>
                        <div class="uk-form-controls">
                            <textarea wire:model.defer="overview" id="overview" rows="4"
                    ...
                    <div class="uk-panel uk-grid-margin">
                        <label for="experience" class="uk-form-label uk-text-bold">Experience needed</label>
                        <div class="uk-form-controls">
                    ...
                    <div class="uk-panel uk-grid-margin">
                        <label for="perks" class="uk-form-label uk-text-bold">Salary and Perks</label>
                        <div class="uk-form-controls">
                            <textarea wire:model.defer="perks" id="perks" rows="4"
                    ...
                    <div class="uk-panel uk-width-1-1@m uk-grid-margin">
                        <label for="tags" class="uk-form-label uk-text-bold">Tools used or Skillset (comma separated
                            attributes)</label>
                        <div class="uk-form-controls">
                    ...
                    <div class="uk-width-1-1 uk-grid-margin">
                        ...
                        <div>
                            <button type="submit"
                                ...
                                <span>Next</span>
                                <span wire:loading.delay.long wire:target="submit"
                                    class="uk-margin-small-left uk-icon uk-spinner" uk-spinner="ratio: 0.6"></span>
                            </button>
                        </div>
                    </div>
                </div>
